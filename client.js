        ...
        *  qui contient l'intéraction cliquée par le joueur */
        ...
        socket.on('invitedToGame', function(source, message) {
            ...
            buttonAccept.addEventListener('click', function() {
                ...
                context = document.createTextNode('Vous allez être redirigé vers la partie dans quelques secondes');
                gameInvitationWindow.appendChild(context);
                afficheElement(gameInvitationWindow);
        ...
        socket.on('invHasBeenAccepted', function(message) {
            ...
            var redirection = document.createTextNode('Vous allez être redirigé vers la partie dans quelques secondes');
            gameInvitationWindow.appendChild(context);
            gameInvitationWindow.appendChild(redirection);
            afficheElement(gameInvitationWindow);
            setTimeout(redirectToGame, 5000);
        });