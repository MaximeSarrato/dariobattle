...
socket.on('roomHasBeenJoined', function(playerName, room) {
  ...
  console.log(
    'Le joueur ' + playerName + ' a rejoint la salle ' + '"' + room + '"'
  );
});
...
function animation() {
  ...
  if (tempsPasse > fpsRate) {
    ...
    // Si il court
    if (player2.running) ctx.drawImage(luigiRunningLeft, player2.x, player2.y);
    ...
    if (player1.running && !player1.jumping) {
      if (keyD) player1.image.src = '/img/marioRunningRight.png';
      else if (keyQ) player1.image.src = '/img/marioRunningLeft.png';
      ctx.drawImage(player1.image, player1.x, player1.y);
    } else if (player1.jumping || player1.goDown) {
      // Si le joueur saute ou qu'il a sauté et est en train de retomber
      if (keyD) player1.image.src = '/img/marioJumpingRight.png';
      else if (keyQ) player1.image.src = '/img/marioJumpingLeft.png';
      else player1.image.src = '/img/marioJumpingRight.png';
      ctx.drawImage(player1.image, player1.x, player1.y);
      ...
      if (keyD) player1.image.src = '/img/marioCrouchRight.png';
      else if (keyQ) player1.image.src = '/img/marioCrouchLeft.png';
      else player1.image.src = '/img/marioCrouchRight.png';
      ctx.drawImage(player1.image, player1.x, player1.y + 15);
    }
